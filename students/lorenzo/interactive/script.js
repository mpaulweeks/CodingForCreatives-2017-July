...
var buttonBar = document.getElementById("bar-open")
...
var funcOpenbar = function(){
  buttonBar.classList.remove("on-top");
  divBar.classList.add("on-top");
}
...
buttonBar.addEventListener('click', funcOpenbar)
